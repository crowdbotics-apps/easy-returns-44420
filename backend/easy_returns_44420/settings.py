"""
Django settings for easy_returns_44420 project.
...
ROOT_URLCONF = 'easy_returns_44420.urls'
...
WSGI_APPLICATION = 'easy_returns_44420.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "easy_returns_44420 API",
    "DESCRIPTION": "API documentation for easy_returns_44420 App",
    "VERSION": "v1",
}
